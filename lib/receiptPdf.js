...
// Bank account block (if set) + the invoiceFooter thank-you line — mirrors ReceiptFooter. The bank
// account sits in its own bordered box, one field per row (Bank Name / Account Number / Account Name).
